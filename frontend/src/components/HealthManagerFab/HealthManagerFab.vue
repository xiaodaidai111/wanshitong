<template>
  <view class="health-manager-fab">
    <view
      ...
      @click.stop="onClick"
    >
      <image class="fab-image" src="/static/healthymanager.png" mode="aspectFill"></image>
      ...
      <view class="panel-header">
        <view class="header-left">
          <view class="bot-avatar">
            <image class="avatar-image" src="/static/healthymanager.png" mode="aspectFill"></image>
          </view>
          <view class="bot-info">
...
const UI_TEXT = {
  ...
  placeholder: "\u8be2\u95ee\u753b\u50cf\u52a9\u624b...",
  sendText: "\u53d1\u9001",
  busyText: "\u62b1\u6b49\uff0c\u753b\u50cf\u52a9\u624b\u73b0\u5728\u6709\u70b9\u5fd9\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5\u3002",
  networkErrorText: "\u8fde\u63a5\u753b\u50cf\u52a9\u624b\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u7f51\u7edc\u8fde\u63a5\u3002"
}
const DEFAULT_BOT_MESSAGE = "\u4f60\u597d\uff0c\u6211\u662f\u753b\u50cf\u52a9\u624b\uff0c\u53ef\u4ee5\u5e2e\u4f60\u68b3\u7406\u4e13\u4e1a\u3001\u5b66\u4e60\u76ee\u6807\u3001\u77e5\u8bc6\u57fa\u7840\u548c\u6613\u9519\u70b9\u3002"
...
export default {
  ...
  methods: {
    ...
    async sendMessage() {
      ...
      try {
        const res = await request.post("/health/api/chat", {
