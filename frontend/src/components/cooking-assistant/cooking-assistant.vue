    ...
    <view class="cooking-content">
      <view class="step-content">
        ...
        <view class="step-heat">
          <view class="heat-header">
            ...
            <text class="heat-label">火候建�?/text>
          </view>
          <view class="heat-info">
            <view class="heat-level">
              <text class="heat-label-text">推荐火候：</text>
              <text class="heat-value">{{ heatLevel }}</text>
            </view>
            <view class="heat-time">
              <text class="heat-label-text">建议时间�?/text>
      ...
      <view class="ingredients-panel" v-if="showIngredientsPanel">
        <view class="panel-header">
          <text class="panel-title">📋 食材准备清单</text>
      ...
      <view class="questions-panel" v-if="showQuestionsPanel">
        <view class="panel-header">
          <text class="panel-title">�?烹饪问题解答</text>
      ...
      questions: [
        {
          title: '糖炒糊了怎么办？',
          preview: '立即关火，加少量热水...',
          solution: '立即关火，加少量热水，快速搅拌可以挽救糊掉的糖色�?
        },
        {
          title: '肉炒老了怎么补救�?,
          preview: '加入少量淀粉水勾芡...',
          solution: '加入少量淀粉水勾芡，可以增加肉的嫩度和口感�?
        },
        {
          title: '汤太咸了怎么办？',
          preview: '加入土豆或豆�?..',
          solution: '加入土豆或豆腐，可以吸收多余的盐分，让汤变得清淡�?
        }
      ]
    }
  },
