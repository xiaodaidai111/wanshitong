      ...
      <view class="module-grid">
        ...
        >
          ...
          <view class="module-info">
            <text class="module-title">智能问修</text>
            <text class="module-desc">故障问答 · 分步排查 · 图文解析</text>
          </view>
        ...
        >
          ...
          <view class="module-info">
            <text class="module-title">知识检索</text>
            <text class="module-desc">文本检索 · 图片匹配 · 型号查询</text>
          </view>
          <view class="module-arrow">�?/view>
        </view>
        ...
        >
          ...
          <view class="module-info">
            <text class="module-title">检修评估</text>
            <text class="module-desc">质量评分 · 风险闭环 · 复盘报告</text>
          </view>
          <view class="module-arrow">�?/view>
        </view>
        ...
        >
          ...
          <view class="module-info">
            <text class="module-title">标准作业</text>
            <text class="module-desc">步骤流程 · 合规校验 · 安全提醒</text>
          </view>
          <view class="module-arrow">�?/view>
        </view>
